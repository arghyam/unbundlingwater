  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      >
        ...
        <Typography variant="h6" sx={{ flexGrow: 1, ml: 7, color: "#fff" }}>
          Unbundling Water
        </Typography>
      </Box>
        ...
        <Container maxWidth="md">
          ...
          <Content>
            <Typography variant="body1" gutterBottom>
              ...
              access to water remains reliable, safe, and fair. The Unbundling
              Water Assets initiative brings attention to these key
              contributors.
            </Typography>
            <Typography
              variant="body1"
            ...
            <List>
              <ListItem>
                ...
                <ListItemText primary="Discover over 25,000 digitally verified water workers trained in groundwater management, natural resource planning, and more." />
              </ListItem>
              <ListItem>
                <ListItemIcon>
                  <Water color="primary" />
                </ListItemIcon>
                <ListItemText primary="Access expert-led training resources covering 500+ topics in states like Meghalaya, Gujarat, Bihar, and Karnataka." />
              </ListItem>
              <ListItem>
                <ListItemIcon>
                  <School color="primary" />
                </ListItemIcon>
                <ListItemText primary="Engage with workers skilled in community engagement, water quality testing, and plumbing." />
              </ListItem>
              <ListItem>
                <ListItemIcon>
                  <Group color="primary" />
                </ListItemIcon>
                <ListItemText primary="Empower rural communities by connecting with local water resource professionals." />
              </ListItem>
            </List>
          </Content>
