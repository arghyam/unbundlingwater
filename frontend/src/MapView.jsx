...
const districtCoordinates = {
  ...
  Maharashtra: {
    "Nashik District": [20.011, 73.7903],
    ...
    Harsule: [20.1436, 73.922],
    "Pimpri Chinchwad": [18.6279, 73.8007],
  },
  "West Bengal": {
    "Jalpaiguri District": [26.5468, 88.7197],
    "North Twenty Four Parganas District": [22.671, 88.6348],
    "Darjeeling District": [27.036, 88.2627],
  ...
  Jharkhand: {
    ...
    "West Singhbhum District": [22.576, 85.6222],
  ...
  Meghalaya: {
    ...
    "East Khasi Hills District": [25.467, 91.3662],
  },
  Uttarakhand: {
  ...
  Assam: {
    ...
    "Dhemaji District": [27.492, 94.5861],
  ...
  Telangana: {
    ...
    "Ranga Reddy District": [17.185, 78.391],
    "Rangareddy District": [17.3456, 78.5576],
    "Suryapet District": [17.1398, 79.62],
    ...
    userData.forEach((user) => {
      ...
      if (isNaN(lat) || isNaN(lng)) {
        ...
        const userIcon = createUserIcon(
          stateColors[selectedState] || "#FF5733"
        );
